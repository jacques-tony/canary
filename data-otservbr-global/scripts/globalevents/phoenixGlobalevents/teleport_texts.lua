local effects = {
    ...
    {position = Position(17567, 17569, 6), text = 'HUNTED!', effect = CONST_ME_GROUNDSHAKER}, 
    ...
    ------- MONSTROS
    {position = Position(17494, 17604, 6), text = '+ 500 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17494, 17604, 6), text = 'MOUNTS ISLAND', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17489, 17604, 6), text = '+ 200 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17489, 17604, 6), text = 'QUIREFANG', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17608, 6), text = '+ 400 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17608, 6), text = 'FEYRIST', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17612, 6), text = '+ 600 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17612, 6), text = 'INGOL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17612, 6), text = '+ 800 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17487, 17612, 6), text = 'GNOMPRONA', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17620, 7), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17619, 7), text = '+ 200 LEVEL', effect = CONST_ME_GROUNDSHAKER},

    {position = Position(17490, 17618, 8), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17618, 8), text = '+ 400 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17623, 8), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17623, 8), text = '+ 400 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17621, 9), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17620, 9), text = '+ 600 LEVEL', effect = CONST_ME_GROUNDSHAKER},

    {position = Position(17490, 17618, 10), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17618, 10), text = '+ 800 LEVEL', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17623, 10), text = 'NEED', effect = CONST_ME_GROUNDSHAKER},
    {position = Position(17490, 17623, 10), text = '+ 800 LEVEL', effect = CONST_ME_GROUNDSHAKER},
