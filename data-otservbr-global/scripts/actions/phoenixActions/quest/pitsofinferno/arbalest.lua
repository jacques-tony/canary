local arbalest = Action()

local cfgItems = {{5803, 1}}

function arbalest.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    elseif player:getStorageValue(15135) <= 0 then
        player:sendTextMessage(MESSAGE_INFO_DESCR, "did you find one Arbalest.")
