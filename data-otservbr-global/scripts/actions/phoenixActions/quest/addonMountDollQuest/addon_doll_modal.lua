local outfits = {
    ...
    -- Config
        storageID = 8778, -- Storage value.
        action_aid = 33226, -- ActionID.
...
local addonsModal = Action()
function addonsModal.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    player:sendAddonWindow(outfits)
end
addonsModal:aid(outfits.action_aid)
addonsModal:register()