...
spell:vocation("druid;true", "sorcerer;true", "elder druid;true", "master sorcerer;true","ancient druid;true","supreme ancient;true","masterful sorcerer;true","supreme masterful;true")
spell:register()
