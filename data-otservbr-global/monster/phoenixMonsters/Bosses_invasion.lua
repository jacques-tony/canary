local mType = Game.createMonsterType("Bosses Invasion")
local monster = {}

monster.description = "Bosses Invasion"
...
monster.defenses = {
	...
	armor = 160,
	--	mitigation = ???,
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Gaz'Haragoth" },
}
