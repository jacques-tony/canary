local mType = Game.createMonsterType("Bosses Dream Courts")
local monster = {}

monster.description = "Bosses Dream Courts"
...
monster.defenses = {
	...
	armor = 160,
	--	mitigation = ???,
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Plagueroot" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Malofur Mangrinder" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Maxxenius" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Alptramun" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Izcandar The Banished" },
}
