local mType = Game.createMonsterType("Phoenix Trapper")
local monster = {}


monster.description = "a Phoenix Trapper"
...
monster.attacks = {
	{name ="combat", interval = 600, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -1500, maxDamage = -3000, range = 7, radius = 14, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -1500, maxDamage = -3000, range = 7, radius = 14, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = false}
}
