...
monster.defenses = {
	...
	armor = 160,
	--	mitigation = ???,
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Morshabaal" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Brokul" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Scarlett Etzel" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "Faceless Bane" },
	{ name = "outfit", interval = 1000, chance = 10, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 7000, outfitMonster = "The Baron from Below" },
}
