 ...
 -- General Items
{
	...
	name = "General Items",
	rookgaard = true,
	subclasses = {"Utilities", "Tokens", "Forge System", "Wheel Scrolls"},
},
-- Soul
 {
	icons = { "Category_ExclusiveOffers.png" },
...
-- Destruction
{
 icons = { "Category_ExclusiveOffers.png" },
	...
	-- Cosmetics
	{
		...
		name = "Cosmetics",
		rookgaard = true,
		subclasses = { "Mounts", "Outfits", "Common Outfits" }, 
	},
	-- Cosmetics ~ Mounts
	{
	...
	
	{
		...
		offers = {
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Protect your body with heavy armour plates and spiky bones to teach your enemies the meaning of fear! The outfit perfectly suits battle-hardened warriors who rely on their trusty sword and shield.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Conjurer_Male_Addon_3.png", "Outfit_Conjurer_Female_Addon_3.png" },
